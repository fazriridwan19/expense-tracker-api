package com.fazri.expensetrackerapi.resources;


import com.fazri.expensetrackerapi.domain.Category;
import com.fazri.expensetrackerapi.services.CategoryService;
...
public class CategoryResource {
    ...
    public ResponseEntity<List<Category>> getAllCategories(HttpServletRequest request) {
        ...
        List<Category> categories = categoryService.fetchAllCategory(userId);
